...
export function multiplyMatrixAndPoint(matrix, point) {
  // Define each row of matrice into its own variable
  ...
  // Multiply the point for each i, k & l, m for each column, then add together
...
// Function 3.)
// Input: Your members angle of orientation alpha (or theta)
// export function localToGlobal(localK) {
//   // Slice the second matrix up into rows
//   let row0 = [matrixB[ 0], matrixB[ 1], matrixB[ 2], matrixB[ 3]];
//   let row1 = [matrixB[ 4], matrixB[ 5], matrixB[ 6], matrixB[ 7]];
//   let row2 = [matrixB[ 8], matrixB[ 9], matrixB[10], matrixB[11]];
